...
<body>
<form method="POST" action="/ASM_war_exploded/chuc-vu/store" >
    <div class="container">
        <div class="card-body">
...
<%--            <div class="col-md-12">--%>
<%--                <label >ID:</label>--%>
<%--                <input type="text" name="id"  class="form-control"  disabled> <br><br>--%>
<%--            </div>--%>
            <div class="col-md-12">
                <label >Mã:</label>
                <input type="text" name="ma"  class="form-control" > <br><br>
                <div class="error " style="color: red" ><p>${checkma}</p></div>
                <div class="error " style="color: red"><p>${trungMa}</p></div>
            </div>
            <div class="col-md-12">
                <label >Tên :</label>
